/** \file
   Prototypes and definitions for the Levenberg - Marquardt minimization
	 algorithm.
...
/* unconstrained minimization: uncertainty*/
extern int dlevmar_der_un(
      void (*func)(double *p, double *hx, int m, int n, void *adata),
      void (*jacf)(double *p, double *j, int m, int n, void *adata),
      double *p, double *x, int m, int n, int itmax, double *opts,
      double *info, double *work, double *uncer, void *adata);

extern int dlevmar_dif_un(
      void (*func)(double *p, double *hx, int m, int n, void *adata),
      double *p, double *x, int m, int n, int itmax, double *opts,
      double *info, double *work, double *uncer, void *adata);
