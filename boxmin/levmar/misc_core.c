...
/** \file
 * The core code for Miscelaneous functions for Levenberg-Marquardt nonlinear
 * minimization. The same core code is used with appropriate \#defines to
 * derive single and double precision versions.
 */
